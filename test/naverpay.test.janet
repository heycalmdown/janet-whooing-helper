...
(deftest
  ...
  (test "convert-an-item"
        (is (= "2020-09-05 18400 기타+ 네이버페이포인트- ? ;사용 2020-09-05 -18400 결제 시 사용 배달의안민족" (convert (split "사용\n2020.09.05\n결제 시 사용\n배달의안민족\n-18,400원\n내역삭제")))))
  (test "배달의민족은 식비로 처리해야 한다"
        (is (= "2020-09-05 18400 식비+ 네이버페이포인트- ? ;사용 2020-09-05 -18400 결제 시 사용 배달의민족" (convert (split "사용\n2020.09.05\n결제 시 사용\n배달의민족\n-18,400원\n내역삭제"))))))
